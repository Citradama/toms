...
public class McategoryListVM {
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view) {
		...
		if (grid != null) {
			grid.setRowRenderer(new RowRenderer<Mcategory>() {
				...
				@Override
				public void render(Row row, Mcategory data, int index) throws Exception {
	...
	public void doAddnew() {
		Window win = (Window) Executions.createComponents("/view/master/ctg/categoryform.zul", null, null);
		win.setClosable(true);
		win.doModal();
		win.addEventListener(Events.ON_CLOSE, new EventListener<Event>() {
